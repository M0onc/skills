...
2. Select "New Entity Filing" → "Corporation — Domestic"
3. For registered agent: select "entity," enter full RA name, pick exact match, verify it shows as **"commercial"** registered agent
4. Pay filing fee online (credit card accepted)
5. Save/download the stamped Articles and note the **Entity Number**

### Filing Fees
| Item | Cost | When |
|------|------|------|
| Articles of Incorporation | ~$75 | At filing |
| Initial List of Officers + Business License | ~$350 | Within 30 days of incorporation |
| Registered Agent (annual) | ~$100-150 | Annual |
| EIN | Free | After incorporation |
| **Total to incorporate** | **~$525-575** | |

### Annual Requirements
| Item | Cost | When |
|------|------|------|
| Annual List of Officers/Directors | ~$150 | Anniversary of incorporation |
| Business License Renewal | ~$200 | Anniversary of incorporation |
...
2. Initial List of Officers/Directors (filed within 30 days)
3. Bylaws (internal, not filed)
4. Organizational Resolutions (internal)
5. Stock Ledger (internal, must be maintained per NRS 78.105)

## Post-Incorporation Deadlines
- **30 days:** File Initial List of Officers/Directors + Business License at SilverFlume
...
- **Northwest Registered Agent** — $125/yr, includes mail scanning, business address
